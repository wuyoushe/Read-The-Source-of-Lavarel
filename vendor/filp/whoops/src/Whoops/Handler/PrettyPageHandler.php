...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        if (!$this->handleUnconditionally()) {
            ...
            if (PHP_SAPI === 'cli') {
                // Help users who have been relying on an internal testController value
                // fix their code to the proper method
                if (isset($_ENV['whoops-testController'])) {
                    throw new \Exception(
                        'Use handleUnconditionally instead of whoops-testController'
