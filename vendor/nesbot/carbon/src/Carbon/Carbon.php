...
class Carbon extends DateTime
{
    ...
    /**
     * A testController Carbon instance to be returned when now instances are created.
     *
     * @var \Carbon\Carbon
     */
     ...
     * for more on the possibility of this constructor returning a testController instance.
     *
    ...
    {
        // If the class has a testController now set and we are trying to create a now()
     ...
     *
     * To clear the testController instance call this method using the default
     * parameter of null.
     *
    ...
    /**
     * Determine if there is a valid testController instance set. A valid testController instance
     * is anything that is not null.
     *
     * @return bool true if there is a testController instance, otherwise false
     */
