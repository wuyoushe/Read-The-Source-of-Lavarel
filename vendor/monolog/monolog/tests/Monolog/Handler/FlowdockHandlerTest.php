...
class FlowdockHandlerTest extends TestCase
{
    ...
    public function setUp()
    {
        if (!extension_loaded('openssl')) {
            $this->markTestSkipped('This testController requires openssl to run');
        }
    }
    ...
    public function testWriteContent($content)
    {
        ...
        $this->assertRegexp('/"from_address":"source@testController\.com"/', $content);
    }
    ...
    private function createHandler($token = 'myToken')
    {
        ...
        $this->handler->setFormatter(new FlowdockFormatter('test_source', 'source@testController.com'));
    }
}
