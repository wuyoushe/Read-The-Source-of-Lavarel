...
class DeduplicationHandlerTest extends TestCase
{
    ...
    public function testGcOldLogs()
    {
        ...
        $handler->flush();
        $this->assertSame(
            $record['datetime']->getTimestamp() . ":ERROR:testController\n" .
            $record2['datetime']->getTimestamp() . ":CRITICAL:testController\n" .
            $record3['datetime']->getTimestamp() . ":CRITICAL:testController\n",
