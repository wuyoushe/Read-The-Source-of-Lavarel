...
class PHPConsoleHandlerTest extends TestCase
{
    ...
    {
        return new Logger('testController', array(
    ...
    {
        $this->debugDispatcher->expects($this->once())->method('dispatchDebug')->with($this->equalTo('testController'));
        $this->initLogger()->addDebug('testController');
    }
    ...
    public function testDebugTags($tagsContextKeys = null)
    {
        ...
        foreach ($tagsContextKeys as $key) {
            ...
            $logger->addDebug('testController', array($key => $expectedTags));
        }
    }
    ...
    public function testOptionEnabled()
    {
        ...
        $this->initLogger(array('enabled' => false))->addDebug('testController');
    }
