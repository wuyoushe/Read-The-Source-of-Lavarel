...
class LineFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testFormatExtras()
    {
        ...
        $message = $formatter->format(array(
            ...
            'context' => array(),
            'datetime' => new \DateTime,
            'extra' => array('ip' => '127.0.0.1', 'file' => 'testController'),
            'message' => 'log',
        ));
        $this->assertEquals('['.date('Y-m-d').'] meh.ERROR: log [] testController {"ip":"127.0.0.1"}'."\n", $message);
    }
    ...
    public function testBatchFormat()
    {
        ...
        $this->assertEquals('['.date('Y-m-d').'] testController.CRITICAL: bar [] []'."\n".'['.date('Y-m-d').'] log.WARNING: foo [] []'."\n", $message);
    }
