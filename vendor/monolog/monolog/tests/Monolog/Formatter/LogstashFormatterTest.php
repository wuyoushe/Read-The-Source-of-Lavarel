...
class LogstashFormatterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $formatter = new LogstashFormatter('testController', 'hostname');
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
        ...
        $this->assertEquals('testController', $message['@type']);
    ...
    {
        $formatter = new LogstashFormatter('testController');
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
            ...
            'datetime' => new \DateTime("@0"),
            'extra' => array('file' => 'testController', 'line' => 14),
            'message' => 'log',
        );

        $message = json_decode($formatter->format($record), true);

        $this->assertEquals('testController', $message['@fields']['file']);
    ...
    public function testFormatWithContext()
    {
        ...
        $formatter = new LogstashFormatter('testController', null, null, 'CTX');
        $message = json_decode($formatter->format($record), true);
    ...
    public function testFormatWithExtra()
    {
        ...
        // Test with extraPrefix
        $formatter = new LogstashFormatter('testController', null, 'EXT');
        $message = json_decode($formatter->format($record), true);
    ...
    {
        $formatter = new LogstashFormatter('app', 'testController');
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
    ...
    {
        $formatter = new LogstashFormatter('testController', 'hostname', null, 'ctxt_', LogstashFormatter::V1);
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
    ...
    {
        $formatter = new LogstashFormatter('testController', null, null, 'ctxt_', LogstashFormatter::V1);
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
        ...
        $this->assertEquals('testController', $message['file']);
    ...
    public function testFormatWithContextV1()
    {
        ...
        // Test with extraPrefix
        $formatter = new LogstashFormatter('testController', null, null, 'CTX', LogstashFormatter::V1);
        $message = json_decode($formatter->format($record), true);
    ...
    public function testFormatWithExtraV1()
    {
        ...
        // Test with extraPrefix
        $formatter = new LogstashFormatter('testController', null, 'EXT', 'ctxt_', LogstashFormatter::V1);
        $message = json_decode($formatter->format($record), true);
    ...
    {
        $formatter = new LogstashFormatter('app', 'testController', null, 'ctxt_', LogstashFormatter::V1);
        $record = array(
            'level' => Logger::ERROR,
            'level_name' => 'ERROR',
            'channel' => 'meh',
