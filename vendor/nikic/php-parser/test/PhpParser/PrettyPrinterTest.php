...
class PrettyPrinterTest extends CodeTestAbstract
{
    ...
    public function provideTestPrettyPrint() {
        return $this->getTests(__DIR__ . '/../code/prettyPrinter', 'testController');
    }

    public function provideTestPrettyPrintFile() {
        return $this->getTests(__DIR__ . '/../code/prettyPrinter', 'file-testController');
    }
...
CODE
    ...
    public function provideTestFormatPreservingPrint() {
        return $this->getTests(__DIR__ . '/../code/formatPreservation', 'testController', 3);
    }
    ...
    public function testRoundTripPrint($name, $code, $expected, $modeLine) {
        /**
         * This testController makes sure that the format-preserving pretty printer round-trips for all
    ...
    public function provideTestRoundTripPrint() {
        return array_merge(
            $this->getTests(__DIR__ . '/../code/prettyPrinter', 'testController'),
            $this->getTests(__DIR__ . '/../code/parser', 'testController')
        );
    }
}
