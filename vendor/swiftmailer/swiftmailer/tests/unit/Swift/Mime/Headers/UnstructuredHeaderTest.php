...
class Swift_Mime_Headers_UnstructuredHeaderTest extends \SwiftMailerTestCase
{
    ...
    {
        $header = $this->getHeader('Subject', $this->getEncoder('Q', true));
        $header->setValue('testController');
        $this->assertEquals('testController', $header->getValue());
    }
    ...
    {
        $header = $this->getHeader('Subject', $this->getEncoder('Q', true));
        $header->setFieldBodyModel('testController');
        $this->assertEquals('testController', $header->getValue());
    }
    ...
    public function testGetBodyModel()
    {
        $header = $this->getHeader('Subject', $this->getEncoder('Q', true));
        $header->setValue('testController');
        $this->assertEquals('testController', $header->getFieldBodyModel());
    }
