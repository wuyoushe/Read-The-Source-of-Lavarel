...
class Swift_Signers_DKIMSignerTest extends \SwiftMailerTestCase
{
    ...
    private function createHeaders()
    {
        ...
        $headers->shouldReceive('getAll')
                ->zeroOrMoreTimes()
                ->with('From')
                ->andReturn(array($headerFactory->createMailboxHeader('From', 'testController@testController.testController')));
        $headers->shouldReceive('has')
                ->zeroOrMoreTimes()
                ->with('To')
                ->andReturn(true);
        $headers->shouldReceive('getAll')
                ->zeroOrMoreTimes()
                ->with('To')
                ->andReturn(array($headerFactory->createMailboxHeader('To', 'testController@testController.testController')));
        $headers->shouldReceive('has')
                ->zeroOrMoreTimes()
                ->with('Date')
                ->andReturn(true);
