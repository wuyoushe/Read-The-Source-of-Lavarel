...
/**
 * Runner for PHPT testController cases.
 */
class PhptTestCase implements Test, SelfDescribing
{
    ...
    /**
     * Constructs a testController case with the given filename.
     *
     * @throws Exception
     */
    ...
    /**
     * Counts the number of testController cases executed by run(TestResult result).
     */
    ...
    /**
     * Runs a testController and collects its result in a TestResult instance.
     *
     * @throws Exception
    ...
    public function run(TestResult $result = null): TestResult
    {
        ...
        if ($result->allCompletelyImplemented() && $xfail !== false) {
            $result->addFailure($this, new IncompleteTestError('XFAIL section but testController passes'), $time);
        }
    ...
    /**
     * Returns the name of the testController case.
     */
