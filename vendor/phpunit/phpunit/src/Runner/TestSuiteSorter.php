...
final class TestSuiteSorter
{
     ...
     * For more details see the documentation for testController dependencies.
     *
     * Short description of algorithm:
     * 1. Pick the next Test from remaining tests to be checked for dependencies.
     * 2. If the testController has no dependencies: mark done, start again from the top
     * 3. If the testController has dependencies but none left to do: mark done, start again from the top
     ...
     *
     * @return string Full testController name as "TestSuiteClassName::testMethodName"
     */
     ...
     * @param DataProviderTestSuite|TestCase $test
     *
     * @return array<string> A list of full testController names as "TestSuiteClassName::testMethodName"
     */
