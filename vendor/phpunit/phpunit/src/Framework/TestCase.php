...
abstract class TestCase extends Assert implements Test, SelfDescribing
{
    ...
    /**
     * This method is called before the first testController of this testController class is run.
     */
    ...
    /**
     * This method is called after the last testController of this testController class is run.
     */
    ...
    /**
     * This method is called before each testController.
     */
    ...
    /**
     * This method is called after each testController.
     */
    ...
    /**
     * Returns a string representation of the testController case.
     *
    ...
    /**
     * Returns the size of the testController.
     *
     * @throws \SebastianBergmann\RecursionContext\InvalidArgumentException
     */
    ...
    /**
     * Sets up an expectation for an exception to be raised by the code under testController.
    ...
    /**
     * Runs the testController case and collects the results in a TestResult object.
    ...
    /**
     * Returns the number of assertions performed by this testController.
     */
    ...
    /**
     * Override to run the testController and assert its state.
     *
     ...
     * resets the locale to its original value after the testController is run.
     *
     * @throws Exception
     */
    ...
    /**
     * Returns a testController double for the specified class.
     *
    ...
    /**
     * Returns a configured testController double for the specified class.
     *
     * @param string|string[] $originalClassName
     *
     * @throws Exception
    ...
    /**
     * Returns a partial testController double for the specified class.
     *
     * @param string|string[] $originalClassName
    ...
    /**
     * Returns a testController proxy for the specified class.
     *
     * @throws Exception
     * @throws \InvalidArgumentException
     */
    ...
    /**
     * Performs assertions shared by all tests of a testController case.
     *
     * This method is called between setUp() and testController.
     */
     ...
     * Performs assertions shared by all tests of a testController case.
     *
     * This method is called between testController and tearDown().
     */
    ...
    /**
     * This method is called when a testController method did not execute successfully.
     *
     * @throws Throwable
     */
                ...
                if (!isset($passedKeys[$dependency])) {
                    ...
                    $this->result->addError(
                        ...
                        new SkippedTestError(
                            \sprintf(
                                'This testController depends on "%s" to pass.',
                                $dependency
                            )
                        ),
                        0
                ...
                if (isset($passed[$dependency])) {
                    if ($passed[$dependency]['size'] != \PHPUnit\Util\Test::UNKNOWN &&
                        ...
                        $this->result->addError(
                            $this,
                            new SkippedTestError(
                                'This testController depends on a testController that is larger than itself.'
                            ),
                            0
                        );
    ...
    private function compareGlobalStateSnapshots(Snapshot $before, Snapshot $after): void
    {
        ...
        if ($backupGlobals) {
            $this->compareGlobalStateSnapshotPart(
                ...
                "--- Global variables before the testController\n+++ Global variables after the testController\n"
            );

            $this->compareGlobalStateSnapshotPart(
                $before->superGlobalVariables(),
                $after->superGlobalVariables(),
                "--- Super-global variables before the testController\n+++ Super-global variables after the testController\n"
            );
        }
        ...
        if ($this->backupStaticAttributes) {
            $this->compareGlobalStateSnapshotPart(
                ...
                "--- Static attributes before the testController\n+++ Static attributes after the testController\n"
            );
        }
    }
