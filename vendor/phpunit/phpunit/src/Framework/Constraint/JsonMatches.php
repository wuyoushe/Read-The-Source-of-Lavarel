...
class JsonMatches extends Constraint
{
    ...
    /**
     * Throws an exception for the given compared value and testController description
     *
     * @param mixed             $other             evaluated value or object
     * @param string            $description       Additional information about the testController
