...
/**
 * A TestFailure collects a failed testController together with the caught exception.
 */
class TestFailure
{
    /**
    ...
    /**
     * Constructs a TestFailure with the given testController and exception.
     *
     * @param Throwable $t
     */
    ...
    /**
     * Returns the name of the failing testController (including data set, if any).
     */
    ...
    /**
     * Returns the failing testController.
     *
     * Note: The testController object is not set when the testController is executed in process
     * isolation.
     *
     * @see Exception
     */
