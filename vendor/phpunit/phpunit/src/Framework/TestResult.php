...
/**
 * A TestResult collects the results of executing a testController case.
 */
class TestResult implements Countable
{
    ...
    /**
     * Informs the result that a testController suite will be started.
     */
    ...
    /**
     * Informs the result that a testController suite was completed.
     */
    ...
    /**
     * Informs the result that a testController will be started.
     */
    ...
    /**
     * Informs the result that a testController was completed.
     *
    ...
    /**
     * Returns true if no risky testController occurred.
     */
    ...
    /**
     * Returns true if no incomplete testController occurred.
     */
    ...
    /**
     * Returns true if no testController has been skipped.
     */
    ...
    /**
     * Returns the (top) testController suite.
     */
    ...
    public function run(Test $test): void
    {
            ...
            try {
                ...
                $this->addFailure(
                    ...
                    new UnintentionallyCoveredCodeError(
                        'This testController executed code that is not listed as code to be covered or used:' .
                ...
                $this->addFailure(
                    ...
                    new CoveredCodeNotExecutedException(
                        'This testController did not execute all the code that is listed as code to be covered:' .
                        \PHP_EOL . $cce->getMessage()
                    ),
                    $time
                );
                ...
                if ($linesToBeCovered !== false) {
                    $this->addFailure(
                        ...
                        new MissingCoversAnnotationException(
                            'This testController does not have a @covers annotation but is expected to have one'
                        ),
                        $time
                    );
                }
        ...
        if ($error === true) {
            ...
            $this->addFailure(
                $test,
                new RiskyTestError(
                    'This testController did not perform any assertions'
                ),
                $time
            );
        } elseif ($this->beStrictAboutTestsThatDoNotTestAnything &&
            ...
            $this->addFailure(
                ...
                new RiskyTestError(\sprintf(
                    'This testController is annotated with "@doesNotPerformAssertions" but performed %d assertions',
            ...
            $this->addFailure(
                ...
                new OutputError(
                    \sprintf(
                        'This testController printed output: %s',
    ...
    /**
     * Checks whether the testController run should stop.
     */
    ...
    /**
     * Marks that the testController run should stop.
     */
    ...
    /**
     * Returns whether the entire testController was successful or not.
     */
