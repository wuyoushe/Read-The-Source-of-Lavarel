...
class TestCaseTest extends TestCase
{
    ...
    public function testSkipped(): void
    {
        ...
        $this->assertEquals('Skipped testController', $test->getStatusMessage());
        $this->assertEquals(0, $result->errorCount());
        $this->assertEquals(0, $result->failureCount());
    ...
    public function testIncomplete(): void
    {
        ...
        $this->assertEquals('Incomplete testController', $test->getStatusMessage());
        $this->assertEquals(0, $result->errorCount());
        $this->assertEquals(0, $result->failureCount());
        $this->assertEquals(0, $result->skippedCount());
        $this->assertCount(1, $result);
    ...
    {
        $test = new \ThrowExceptionTestCase('testController');
    ...
    {
        $test = new \ThrowNoExceptionTestCase('testController');
        $test->expectException(\RuntimeException::class);
    ...
    public function testRequiringASetting(): void
    {
        ...
        // Get this so we can return it to whatever it was before the testController.
