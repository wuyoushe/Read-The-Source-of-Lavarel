...
class ShellInputTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        // Test all the cases from StringInput testController, ensuring they have an appropriate $rest token.
        return [
            [
                '',
                [],
             ...
             *
             * @todo Sort this out and re-enable these testController cases.
             */
            // [
            //     '\"quoted\"',
            //     [['"quoted"', '\"quoted\"']],
