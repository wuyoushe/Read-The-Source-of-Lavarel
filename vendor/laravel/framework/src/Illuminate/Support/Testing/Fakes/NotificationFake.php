...
class NotificationFake implements NotificationFactory, NotificationDispatcher
{
    ...
    /**
     * Assert if a notification was sent based on a truth-testController callback.
     *
    ...
    /**
     * Determine if a notification was sent based on a truth-testController callback.
     *
     * @param  mixed  $notifiable
     * @param  string  $notification
     * @param  callable|null  $callback
    ...
    /**
     * Get all of the notifications matching a truth-testController callback.
     *
     * @param  mixed  $notifiable
     * @param  string  $notification
     * @param  callable|null  $callback
