...
class Collection implements ArrayAccess, Arrayable, Countable, IteratorAggregate, Jsonable, JsonSerializable
{
    ...
    /**
     * Determine if all items in the collection pass the given testController.
     *
    ...
    /**
     * Create a collection of all elements that do not pass a given truth testController.
     *
