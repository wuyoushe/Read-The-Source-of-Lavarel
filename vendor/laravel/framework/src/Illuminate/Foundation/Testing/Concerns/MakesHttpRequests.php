...
trait MakesHttpRequests
{
    ...
    /**
     * Disable middleware for the testController.
     *
    ...
    /**
     * Enable the given middleware for the testController.
     *
     * @param  string|array  $middleware
     * @return $this
     */
    ...
    /**
     * Create the testController response instance from the given response.
     *
     * @param  \Illuminate\Http\Response  $response
     * @return \Illuminate\Foundation\Testing\TestResponse
     */
