...
class ProcessTest extends TestCase
{
    ...
    public function testInvalidCwd()
    {
        try {
            ...
            $cmd = new Process('echo testController', __DIR__);
            $cmd->run();
        } catch (\Exception $e) {
            $this->fail($e);
        }

        $cmd = new Process('echo testController', __DIR__.'/notfound/');
        $cmd->run();
    }
    ...
    public function testThatProcessDoesNotThrowWarningDuringRun()
    {
        if ('\\' === DIRECTORY_SEPARATOR) {
            $this->markTestSkipped('This testController is transient on Windows');
        }
    ...
    {
        if ('\\' !== DIRECTORY_SEPARATOR) {
            $this->markTestSkipped('This testController is for Windows platform only');
        }
