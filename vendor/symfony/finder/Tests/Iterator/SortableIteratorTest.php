...
class SortableIteratorTest extends RealIteratorTestCase
{
        ...
        if (!is_callable($mode)) {
            switch ($mode) {
                ...
                case SortableIterator::SORT_BY_CHANGED_TIME:
                    file_put_contents(self::toAbsolute('testControllerController.php'), 'foo');
                    sleep(1);
                    file_put_contents(self::toAbsolute('testController.py'), 'foo');
                    break;
                case SortableIterator::SORT_BY_MODIFIED_TIME:
                    file_put_contents(self::toAbsolute('TestController.phproller.php'), 'foo');
                    sleep(1);
                    file_put_contents(self::toAbsolute('testController.py'), 'foo');
                    break;
            }
    ...
    public function getAcceptData()
    {
        ...
        $sortByAccessedTime = array(
            ...
            array('foo/bar.tmp', 'testControllerController.php'),
        ...
        $sortByChangedTime = array(
            ...
            array('TestController.phproller.php'),
            array('testController.py'),
        );
        ...
        $sortByModifiedTime = array(
            ...
            array('testControllerController.php'),
            array('testController.py'),
        );
