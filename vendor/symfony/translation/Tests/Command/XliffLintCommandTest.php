...
XLIFF;
        ...
        $filename = sprintf('%s/translation-xliff-lint-testController/messages.en.xlf', sys_get_temp_dir());
    ...
    {
        $this->files = array();
        @mkdir(sys_get_temp_dir().'/translation-xliff-lint-testController');
    }
    ...
    protected function tearDown()
    {
        ...
        rmdir(sys_get_temp_dir().'/translation-xliff-lint-testController');
    }
}
