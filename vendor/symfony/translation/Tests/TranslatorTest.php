...
class TranslatorTest extends TestCase
{
    ...
    public function testTransValidLocale($locale)
    {
        $translator = new Translator($locale);
        $translator->addLoader('array', new ArrayLoader());
        $translator->addResource('array', array('testController' => 'OK'), $locale);

        $this->assertEquals('OK', $translator->trans('testController'));
        $this->assertEquals('OK', $translator->trans('testController', array(), null, $locale));
    }
