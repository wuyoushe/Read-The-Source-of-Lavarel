...
class XliffFileLoaderTest extends TestCase
{
    ...
    public function testIncompleteResource()
    {
        ...
        $this->assertEquals(array('foo' => 'bar', 'extra' => 'extra', 'key' => '', 'testController' => 'with'), $catalogue->all('domain1'));
    }
    ...
    public function testLoadVersion2WithNoteMeta()
    {
        ...
        // testController for "foo" metadata
        ...
        // testController for "baz" metadata
    ...
    public function testLoadVersion2WithMultiSegmentUnit()
    {
        ...
        // testController for "bar" metadata
