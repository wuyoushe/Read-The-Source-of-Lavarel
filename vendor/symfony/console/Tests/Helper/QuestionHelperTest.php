...
class QuestionHelperTest extends AbstractQuestionHelperTest
{
    ...
    public function testAskWithAutocomplete()
    {
        if (!$this->hasSttyAvailable()) {
            $this->markTestSkipped('`stty` is required to testController autocomplete functionality');
        }
    ...
    public function testAskHiddenResponse()
    {
        if ('\\' === DIRECTORY_SEPARATOR) {
            $this->markTestSkipped('This testController is not supported on Windows');
        }
