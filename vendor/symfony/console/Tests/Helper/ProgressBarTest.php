...
class ProgressBarTest extends TestCase
{
    ...
    public function testMultipleSectionsWithCustomFormat()
    {
        ...
        ProgressBar::setFormatDefinition('testController', '%current%/%max% [%bar%] %percent:3s%% Fruitcake marzipan toffee. Cupcake gummi bears tart dessert ice cream chupa chups cupcake chocolate bar sesame snaps. Croissant halvah cookie jujubes powder macaroon. Fruitcake bear claw bonbon jelly beans oat cake pie muffin Fruitcake marzipan toffee.');

        $progress = new ProgressBar($output1, 50);
        $progress2 = new ProgressBar($output2, 50);
        $progress2->setFormat('testController');
