...
class ApplicationTest extends TestCase
{
    ...
    public function testFindNonAmbiguous()
    {
        ...
        $this->assertEquals('testController-toto', $application->find('testController')->getName());
    }
...
', $tester->getDisplay(true));
     ...
     * This testController will fail with "Not enough arguments." if broken
     */
    ...
    public function testRunWithDispatcherAddingInputOptions()
    {
        ...
        $tester = new ApplicationTester($application);
        $tester->run(array('command' => 'foo', '--extra' => 'some testController value'));

        $this->assertEquals('some testController value', $extraValue);
    }
