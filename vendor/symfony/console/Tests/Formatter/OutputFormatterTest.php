...
class OutputFormatterTest extends TestCase
{
    ...
    public function testNewStyle()
    {
        ...
        $formatter->setStyle('testController', $style);

        $this->assertEquals($style, $formatter->getStyle('testController'));
        $this->assertNotEquals($style, $formatter->getStyle('info'));

        $style = new OutputFormatterStyle('blue', 'white');
        $formatter->setStyle('b', $style);

        $this->assertEquals("\033[34;47msome \033[39;49m\033[34;47mcustom\033[39;49m\033[34;47m msg\033[39;49m", $formatter->format('<testController>some <b>custom</b> msg</testController>'));
    }
    ...
    public function provideInlineStyleOptionsCases()
    {
        return array(
            ...
            array('<fg=green;>', "\033[32m[testController]\033[39m", '[testController]'),
