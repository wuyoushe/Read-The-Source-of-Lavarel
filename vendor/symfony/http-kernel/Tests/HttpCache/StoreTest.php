...
class StoreTest extends TestCase
{
    ...
    {
        $request = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
    ...
    {
        $this->storeSimpleEntry($path = '/testController?x=y&p=q');
        $hitsReq = Request::create($path);
        $missReq = Request::create('/testController?p=x');
    ...
    public function testRestoresResponseContentFromEntityStoreWithLookup()
    {
        $this->storeSimpleEntry();
        $response = $this->store->lookup($this->request);
        $this->assertEquals($this->getStorePath('en'.hash('sha256', 'testController')), $response->getContent());
    }
    ...
    {
        $req = Request::create('/testController');
    ...
    {
        $req1 = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
        $req2 = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Bling', 'HTTP_BAR' => 'Bam'));
        $res = new Response('testController', 200, array('Vary' => 'Foo Bar'));
    ...
    {
        $req1 = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
        $req2 = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bam'));
        $res = new Response('testController', 200, array('Vary' => array('Foo', 'Bar')));
        $this->store->write($req1, $res);
    ...
    {
        $req1 = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
        $res1 = new Response('testController 1', 200, array('Vary' => 'Foo Bar'));
        $key = $this->store->write($req1, $res1);

        $req2 = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Bling', 'HTTP_BAR' => 'Bam'));
        $res2 = new Response('testController 2', 200, array('Vary' => 'Foo Bar'));
        $this->store->write($req2, $res2);

        $req3 = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Baz', 'HTTP_BAR' => 'Boom'));
        $res3 = new Response('testController 3', 200, array('Vary' => 'Foo Bar'));
        $this->store->write($req3, $res3);

        $this->assertEquals($this->getStorePath('en'.hash('sha256', 'testController 3')), $this->store->lookup($req3)->getContent());
        $this->assertEquals($this->getStorePath('en'.hash('sha256', 'testController 2')), $this->store->lookup($req2)->getContent());
        $this->assertEquals($this->getStorePath('en'.hash('sha256', 'testController 1')), $this->store->lookup($req1)->getContent());
    ...
    public function testOverwritesNonVaryingResponseWithStore()
    {
        ...
        $req3 = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
        $res3 = new Response('testController 3', 200, array('Vary' => 'Foo Bar'));
    ...
    {
        $req = Request::create('/testController', 'get', array(), array(), array(), array('HTTP_FOO' => 'Foo', 'HTTP_BAR' => 'Bar'));
    ...
    protected function storeSimpleEntry($path = null, $headers = array())
    {
        ...
        $this->response = new Response('testController', 200, array('Cache-Control' => 'max-age=420'));
