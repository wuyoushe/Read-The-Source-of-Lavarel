    ...
    public function provideUndefinedMethodData()
    {
        return array(
            ...
            array(
                array(
                  'type' => 1,
                  'message' => 'Call to undefined method class@anonymous::testController()',
                  'file' => '/home/possum/work/symfony/TestController.phproller.php',
                  'line' => 11,
                ),
                'Attempted to call an undefined method named "testController" of class "class@anonymous".',
            ),
        );
    }
}
