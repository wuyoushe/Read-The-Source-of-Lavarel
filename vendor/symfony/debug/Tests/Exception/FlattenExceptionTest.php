...
class FlattenExceptionTest extends TestCase
{
    ...
    {
        $exception = new \Exception('testController', 123, new \ParseError('Oh noes!', 42));
    ...
    {
        return array(
            array(new \Exception('testController', 123), 'Exception'),
            array(new \Error('testController', 123), 'Error'),
        );
    }
