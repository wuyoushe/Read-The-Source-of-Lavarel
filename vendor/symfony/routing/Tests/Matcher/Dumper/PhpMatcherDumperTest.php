...
class PhpMatcherDumperTest extends TestCase
{
    ...
    public function getRouteCollections()
    {
        ...
        /* testController case 3 */

        $rootprefixCollection = new RouteCollection();
        $rootprefixCollection->add('static', new Route('/testController'));
