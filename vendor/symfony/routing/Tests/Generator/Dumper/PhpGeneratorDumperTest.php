...
class PhpGeneratorDumperTest extends TestCase
{
    ...
    {
        $this->routeCollection->add('testController', new Route('/testing/{foo}'));
        ...
        $absoluteUrlWithParameter = $projectUrlGenerator->generate('testController', array('foo' => 'bar'), UrlGeneratorInterface::ABSOLUTE_URL);
        $absoluteUrlWithoutParameter = $projectUrlGenerator->generate('Test2', array(), UrlGeneratorInterface::ABSOLUTE_URL);
        $relativeUrlWithParameter = $projectUrlGenerator->generate('testController', array('foo' => 'bar'), UrlGeneratorInterface::ABSOLUTE_PATH);
    ...
    {
        $this->routeCollection->add('testController.en', (new Route('/testing/is/fun'))->setDefault('_locale', 'en')->setDefault('_canonical_route', 'testController'));
        $this->routeCollection->add('testController.nl', (new Route('/testen/is/leuk'))->setDefault('_locale', 'nl')->setDefault('_canonical_route', 'testController'));
        ...
        $urlWithDefaultLocale = $projectUrlGenerator->generate('testController');
        $urlWithSpecifiedLocale = $projectUrlGenerator->generate('testController', array('_locale' => 'nl'));
        $context->setParameter('_locale', 'en');
        $urlWithEnglishContext = $projectUrlGenerator->generate('testController');
        $context->setParameter('_locale', 'nl');
        $urlWithDutchContext = $projectUrlGenerator->generate('testController');
    ...
    public function testDumpWithoutRoutes()
    {
        ...
        $projectUrlGenerator->generate('testController', array());
    }
    ...
    {
        $this->routeCollection->add('testController', new Route('/testController'));
    ...
    {
        $this->routeCollection->add('testController', new Route('/testing/{foo}', array('foo' => 'bar')));
        ...
        $url = $projectUrlGenerator->generate('testController', array());
