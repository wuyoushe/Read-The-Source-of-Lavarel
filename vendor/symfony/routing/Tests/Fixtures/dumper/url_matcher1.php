...
class ProjectUrlMatcher extends Symfony\Component\Routing\Matcher\UrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        switch ($pathinfo) {
            default:
                $routes = array(
                    '/testController/baz' => array(array('_route' => 'baz'), null, null, null),
                    '/testController/baz.html' => array(array('_route' => 'baz2'), null, null, null),
                    '/testController/baz3/' => array(array('_route' => 'baz3'), null, null, null),
                    '/foofoo' => array(array('_route' => 'foofoo', 'def' => 'testController'), null, null, null),
        ...
        foreach ($regexList as $offset => $regex) {
            while (preg_match($regex, $matchedPathinfo, $matches)) {
                switch ($m = (int) $matches['MARK']) {
                    ...
                    default:
                        $routes = array(
                            46 => array(array('_route' => 'foo', 'def' => 'testController'), array('bar'), null, null),
