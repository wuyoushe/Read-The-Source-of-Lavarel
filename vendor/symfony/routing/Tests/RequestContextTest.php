...
class RequestContextTest extends TestCase
{
    ...
    {
        $request = Request::create('https://testController.com:444/foo?bar=baz');
        $requestContext = new RequestContext();
        ...
        $this->assertEquals('testController.com', $requestContext->getHost());
        $this->assertEquals('https', $requestContext->getScheme());
        ...
        $request = Request::create('http://testController.com:8080/foo?bar=baz');
        $requestContext = new RequestContext();
