...
class AcceptHeaderItemTest extends TestCase
{
    ...
    public function testAttribute()
    {
        ...
        $this->assertFalse($item->hasAttribute('testController'));
        $this->assertNull($item->getAttribute('testController'));
        $this->assertEquals('default', $item->getAttribute('testController', 'default'));

        $item->setAttribute('testController', 'value');
        $this->assertEquals(array('testController' => 'value'), $item->getAttributes());
        $this->assertTrue($item->hasAttribute('testController'));
        $this->assertEquals('value', $item->getAttribute('testController'));
        $this->assertEquals('value', $item->getAttribute('testController', 'default'));
    }
}
