...
class RequestTest extends TestCase
{
    ...
    {
        $request = Request::create('http://user:password@testController.com');
    ...
    {
        $request = Request::create('http://testController.com/foo?bar=baz');
        $this->assertEquals('http://testController.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        $this->assertEquals('testController.com', $request->getHttpHost());
        $this->assertFalse($request->isSecure());

        $request = Request::create('http://testController.com/foo', 'GET', array('bar' => 'baz'));
        $this->assertEquals('http://testController.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Request::create('http://testController.com/foo?bar=foo', 'GET', array('bar' => 'baz'));
        $this->assertEquals('http://testController.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Request::create('https://testController.com/foo?bar=baz');
        $this->assertEquals('https://testController.com/foo?bar=baz', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('bar=baz', $request->getQueryString());
        ...
        $request = Request::create('testController.com:90/foo');
        $this->assertEquals('http://testController.com:90/foo', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('testController.com', $request->getHost());
        $this->assertEquals('testController.com:90', $request->getHttpHost());
        $this->assertEquals(90, $request->getPort());
        $this->assertFalse($request->isSecure());

        $request = Request::create('https://testController.com:90/foo');
        $this->assertEquals('https://testController.com:90/foo', $request->getUri());
        $this->assertEquals('/foo', $request->getPathInfo());
        $this->assertEquals('testController.com', $request->getHost());
        $this->assertEquals('testController.com:90', $request->getHttpHost());
        $this->assertEquals(90, $request->getPort());
        ...
        $request = Request::create('http://testController.com');
        $this->assertEquals('http://testController.com/', $request->getUri());
        ...
        $request = Request::create('http://testController.com?testController=1');
        $this->assertEquals('http://testController.com/?testController=1', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('testController=1', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        $this->assertEquals('testController.com', $request->getHttpHost());
        $this->assertFalse($request->isSecure());

        $request = Request::create('http://testController.com:90/?testController=1');
        $this->assertEquals('http://testController.com:90/?testController=1', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('testController=1', $request->getQueryString());
        $this->assertEquals(90, $request->getPort());
        $this->assertEquals('testController.com:90', $request->getHttpHost());
        ...
        $request = Request::create('http://username:password@testController.com');
        $this->assertEquals('http://testController.com/', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Request::create('http://username@testController.com');
        $this->assertEquals('http://testController.com/', $request->getUri());
        $this->assertEquals('/', $request->getPathInfo());
        $this->assertEquals('', $request->getQueryString());
        $this->assertEquals(80, $request->getPort());
        ...
        $request = Request::create('http://testController.com/?foo');
        $this->assertEquals('/?foo', $request->getRequestUri());
        $this->assertEquals(array('foo' => ''), $request->query->all());

        // assume rewrite rule: (.*) --> app/app.php; app/ is a symlink to a symfony web/ directory
        $request = Request::create('http://testController.com/apparthotel-1234', 'GET', array(), array(), array(),
            array(
                'DOCUMENT_ROOT' => '/var/www/www.testController.com',
                'SCRIPT_FILENAME' => '/var/www/www.testController.com/app/app.php',
                'SCRIPT_NAME' => '/app/app.php',
                'PHP_SELF' => '/app/app.php/apparthotel-1234',
            ));
        $this->assertEquals('http://testController.com/apparthotel-1234', $request->getUri());
    ...
    public function testGetUri()
    {
        ...
        $server['SCRIPT_NAME'] = '/index.php';
        $server['QUERY_STRING'] = 'query=string';
        $server['REQUEST_URI'] = '/path/info?toto=testController&1=1';
        $server['SCRIPT_NAME'] = '/index.php';
    ...
    {
        $request = Request::create('http://testController.com/foo?bar=baz');
        $this->assertEquals('http://testController.com/some/path', $request->getUriForPath('/some/path'));

        $request = Request::create('http://testController.com:90/foo?bar=baz');
        $this->assertEquals('http://testController.com:90/some/path', $request->getUriForPath('/some/path'));

        $request = Request::create('https://testController.com/foo?bar=baz');
        $this->assertEquals('https://testController.com/some/path', $request->getUriForPath('/some/path'));

        $request = Request::create('https://testController.com:90/foo?bar=baz');
        $this->assertEquals('https://testController.com:90/some/path', $request->getUriForPath('/some/path'));
    ...
    public function getQueryStringNormalizationData()
    {
        return array(
            ...
            array('pa%3Dram=foo%26bar%3Dbaz&testController=testController', 'pa%3Dram=foo%26bar%3Dbaz&testController=testController', 'works with encoded delimiters'),
            array('0', '0=', 'allows "0"'),
            ...
            array('foo=bar&&&testController&&', 'foo=bar&testController=', 'removes unneeded delimiters'),
