...
class FileTest extends TestCase
{
    ...
    {
        $path = __DIR__.'/Fixtures/testController.copy.gif';
        $targetDir = __DIR__.'/Fixtures/directory';
        $targetPath = $targetDir.'/testController.copy.gif';
        @unlink($path);
        @unlink($targetPath);
    ...
    public function testMoveWithNewName()
    {
        $path = __DIR__.'/Fixtures/testController.copy.gif';
        $targetDir = __DIR__.'/Fixtures/directory';
        $targetPath = $targetDir.'/testController.newname.gif';
        @unlink($path);
        @unlink($targetPath);
        copy(__DIR__.'/Fixtures/test.gif', $path);

        $file = new File($path);
        $movedFile = $file->move($targetDir, 'testController.newname.gif');
    ...
    {
        $sourcePath = __DIR__.'/Fixtures/testController.copy.gif';
