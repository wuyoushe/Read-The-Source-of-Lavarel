...
class MongoDbSessionHandlerTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->options = array(
            ...
            'database' => 'sf2-testController',
            'collection' => 'session-testController',
        );
    ...
    {
        $this->assertTrue($this->storage->open('testController', 'testController'), 'The "open" method should always return true');
    }
    ...
    public function testRead()
    {
        ...
        // allows to testController for "greater than" values in the $criteria
        $testTimeout = time() + 1;
