...
class ExpectationTest extends MockeryTestCase
{
    ...
    {
        $this->mock->shouldReceive('foo')->with('testController')->andReturn('bar')->byDefault();
        $this->mock->shouldReceive('foo')->with('testController')->andReturn('newbar')->byDefault();
        $this->mock->foo('testController');
        $this->assertEquals('newbar', $this->mock->foo('testController'));
    }
