...
class MockClassWithFinalWakeupTest extends MockeryTestCase
{
    ...
    {
        $mock = $this->container->mock("testController\Mockery\TestWithFinalWakeup");
        $this->assertInstanceOf("testController\Mockery\TestWithFinalWakeup", $mock);
        $this->assertEquals('testController\Mockery\TestWithFinalWakeup::__wakeup', $mock->__wakeup());
