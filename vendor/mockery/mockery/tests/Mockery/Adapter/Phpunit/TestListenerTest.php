...
class Mockery_Adapter_Phpunit_TestListenerTest extends TestCase
{
    protected function setUp()
    {
        ...
        // We intentionally testController the static container here. That is what the
        // listener will check.
        ...
        $this->assertTrue($this->testResult->wasSuccessful(), 'sanity check: empty testController results should be considered successful');
    }
    ...
    public function testSuccessOnClose()
    {
        ...
        $this->assertTrue($this->testResult->wasSuccessful(), 'expected testController result to indicate success');
    }
    ...
    public function testFailureOnMissingClose()
    {
        ...
        $this->listener->endTest($this->test, 0);
        $this->assertFalse($this->testResult->wasSuccessful(), 'expected testController result to indicate failure');
