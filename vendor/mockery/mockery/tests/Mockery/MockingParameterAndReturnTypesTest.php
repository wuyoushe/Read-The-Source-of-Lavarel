...
class MockingParameterAndReturnTypesTest extends MockeryTestCase
{
    ...
    {
        $mock = mock("testController\Mockery\TestWithParameterAndReturnType");
    ...
    public function testMockingClassReturnTypes()
    {
        ...
        $this->assertInstanceOf("testController\Mockery\TestWithParameterAndReturnType", $mock->withClassReturnType());
    }
    ...
    {
        $spy = \Mockery::spy("testController\Mockery\TestWithParameterAndReturnType");

        $this->assertInstanceOf("testController\Mockery\TestWithParameterAndReturnType", $spy->returnSelf());
    }
