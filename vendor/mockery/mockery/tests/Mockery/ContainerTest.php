...
class ContainerTest extends MockeryTestCase
{
    ...
    {
        // eg. In shared testController setup
        $m = mock(array('foo' => 1, 'bar' => 2));

        // and then overridden in one testController
    ...
    public function testSplfileinfoClassMockPassesUserExpectations()
    {
        ...
        // not sure what this testController is for, maybe something special about
        // SplFileInfo
    ...
    /**
     * Meant to testController the same logic as
    ...
    public function testMockingPhpredisExtensionClassWorks()
    {
        if (!class_exists('Redis')) {
            $this->markTestSkipped('PHPRedis extension required for this testController');
        }
        $m = mock('Redis');
    }
    ...
    public function testMockeryCloseForIllegalIssetFileInclude()
    {
        ...
        // no idea what this testController does, adding this as an assertion...
        $this->assertTrue(true);
    }
