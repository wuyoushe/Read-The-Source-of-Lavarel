 ...
 * for each testController and are included by the assertion counter.
 */
trait MockeryPHPUnitIntegration
{
    ...
    /**
     * Performs assertions shared by all tests of a testController case. This method is
     * called before execution of a testController ends and before the tearDown method.
     */
    ...
    {
        if ($this->mockeryOpen) {
            // post conditions wasn't called, so testController probably failed
            Mockery::close();
        }
    }
}
